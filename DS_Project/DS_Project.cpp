...
rc = sqlite3_exec(db, "CREATE TABLE IF NOT EXISTS STUDENT(ID INTEGER PRIMARY KEY ,F_NAME varchar(25) NOT NULL, S_NAME varchar(25) NOT NULL,TH_NAME varchar(25) NOT NULL, PASSWORD INT NOT NULL, ACADEMIC_YEAR INT NOT NULL);", NULL, NULL, &err);
if (rc != SQLITE_OK) {
